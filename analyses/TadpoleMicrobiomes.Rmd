...
# Combine
euk.diversity <- cbind(euk.design.final,richness, euk.even)
...
plot1a + 
  ...
  theme(axis.title = element_text(size=14), axis.text=element_text(size=14),
          ...
          panel.border = element_rect(colour = "black", size=1.25)) + 
  theme(axis.ticks.length=unit(0.3,"cm")) + 
  xlab("PCoA 1 (33.8%)") + ylab("PCoA 2 (18.3%)") +
  ggtitle(label="Ranitomeya variabilis 16S rRNA Community Composition") + 
  theme(plot.title = element_text(color="black", size=14, face="bold.italic"))
...
plot1a + 
  ...
  theme(axis.title = element_text(size=14), axis.text=element_text(size=14),
          ...
          panel.border = element_rect(colour = "black", size=1.25)) + 
  theme(axis.ticks.length=unit(0.3,"cm")) + 
  xlab("PCoA 1 (34.3%)") + ylab("PCoA 2 (26.0%)") +
  ggtitle(label="Ranitomeya imitator 16S rRNA Community Composition") + 
  theme(plot.title = element_text(color="black", size=14, face="bold.italic"))
...
# PERMANOVA
adonis.euk = adonis2(euk.otu~euk.design.final$Diet*euk.design.final$Species,
