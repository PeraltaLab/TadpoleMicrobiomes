...
adonis = adonis2(new.data.i[,-c(1:4)]~Diet, method = "bray", data = new.data.i, perm=1000)
adonis
...
# Simple Hypothesis Testing - both spp.
```{r perMANOVA Bacteria R. variabilis, echo=TRUE}
# R. variabilis lab egg-fed vs. field detritus-fed
...
plot1a + 
  ...
  theme(plot.title = element_text(color="black", size=14, face="bold.italic"))
ggsave("../figures/Ordination_variabilis_imitator_diet.pdf", plot=last_plot(), device=NULL, path=NULL, scale=1, width=6, height=6, dpi=300, limitsize=TRUE)
```
